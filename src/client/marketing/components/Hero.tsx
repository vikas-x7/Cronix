    ...
    <section className="relative w-full overflow-hidden bg-whtie text-black pt-20 pb-10 md:pt-32">
      <div className="container mx-auto px-4 text-center ">
        ...
        <p className="mx-auto mb-7 max-w-xl font-normal text-lg md:text-[16px] text-[#737373]">
          Manage scheduled jobs, automate workflows, trigger APIs, and monitor job runs, logs, and execution history from one powerful dashboard.
        </p>
        ...
        <div className="mb-16 flex flex-col items-center justify-center gap-4 sm:flex-row ">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 bg-[#171717] px-3 py-2 text-white transition-all hover:bg-black/80 sm:w-auto text-[12px] font-medium cursor-pointer"
          >
        ...
        <div className="flex items-center w-full justify-center">
          <div id="hero-image" className="relative w-6xl h-150 mt-10 overflow-hidden">
            <img src="https://i.pinimg.com/1200x/78/3a/50/783a50a193083ef4156c1d3b979fc5d0.jpg" alt="" className="absolute inset-0 w-full h-full object-cover rounded-[4px]" />

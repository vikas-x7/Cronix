...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-white pt-20 overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center py-10 gap-4">
          <p className="text-xs text-gray-400">
            © {currentYear} Outchat AI. All rights reserved.
          </p>
        ...
        <div className="relative mt-10 select-none">
          <h1 className="text-[15vw] font-bold leading-none tracking-tighter text-black text-center md:text-[22vw] lg:text-[25vw]">
            Cronix
          </h1>

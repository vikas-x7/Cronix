  ...
  return (
    <section className="bg-white py-24 px-4">
      <div className="container mx-auto max-w-4xl text-center">
        <h2 className="mb-6 text-4xl font-[500] -tracking-[1px] md:text-5xl lg:text-[30px]">
          Describe your first workflow. Ship it in{" "}
          <br className="hidden md:block" />
          minutes.
        </h2>

        <p className="mb-10 text-lg text-gray-500 md:text-[14px] ">
          Tell us who you looking for and what should happen we handle the rest.
        </p>
